...
-- Online Bookings — see sql/migrations/009_online_bookings.sql for the full
-- rationale (kept separate from repair_jobs until an admin explicitly
-- converts one).
