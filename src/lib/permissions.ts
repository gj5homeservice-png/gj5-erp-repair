...
export const DEFAULT_PERMISSIONS_BY_ROLE: Record<UserRole, ModulePermissions> = {
  ...
  Admin: allFullAccess(),
  'HR Manager': {
    Dashboard: VIEW_ONLY, Repairing: NONE, 'Repair Jobs': NONE, 'Customer Department': NONE, 'Online Bookings': NONE, 'CRM Leads': NONE,
  ...
  'Service Manager': {
    Dashboard: VIEW_ONLY, Repairing: FULL, 'Repair Jobs': FULL, 'Customer Department': FULL, 'Online Bookings': FULL, 'CRM Leads': VIEW_CREATE,
  ...
  Technician: {
    Dashboard: VIEW_ONLY, Repairing: FULL, 'Repair Jobs': FULL_NO_DELETE, 'Customer Department': FULL_NO_DELETE, 'Online Bookings': FULL_NO_DELETE, 'CRM Leads': VIEW_ONLY,
  ...
  'Sales Executive': {
    Dashboard: VIEW_ONLY, Repairing: NONE, 'Repair Jobs': NONE, 'Customer Department': VIEW_ONLY, 'Online Bookings': NONE, 'CRM Leads': FULL_NO_DELETE,
