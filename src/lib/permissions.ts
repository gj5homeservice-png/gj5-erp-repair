...
export const DEFAULT_PERMISSIONS_BY_ROLE: Record<UserRole, ModulePermissions> = {
  ...
  Admin: allFullAccess(),
  'HR Manager': {
    Dashboard: VIEW_ONLY, Repairing: NONE, 'Repair Jobs': NONE, 'Online Bookings': NONE, 'CRM Leads': NONE,
  ...
  'Service Manager': {
    Dashboard: VIEW_ONLY, Repairing: FULL, 'Repair Jobs': FULL, 'Online Bookings': FULL, 'CRM Leads': VIEW_CREATE,
  ...
  Technician: {
    Dashboard: VIEW_ONLY, Repairing: FULL, 'Repair Jobs': FULL_NO_DELETE, 'Online Bookings': FULL_NO_DELETE, 'CRM Leads': VIEW_ONLY,
  ...
  'Sales Executive': {
    Dashboard: VIEW_ONLY, Repairing: NONE, 'Repair Jobs': NONE, 'Online Bookings': NONE, 'CRM Leads': FULL_NO_DELETE,
  ...
  'Delivery Executive': {
    Dashboard: VIEW_ONLY, Repairing: NONE, 'Repair Jobs': VIEW_ONLY, 'Online Bookings': VIEW_ONLY, 'CRM Leads': NONE,
  ...
  'Store Manager': {
    Dashboard: FULL, Repairing: VIEW_ONLY, 'Repair Jobs': FULL_NO_DELETE, 'Online Bookings': FULL_NO_DELETE, 'CRM Leads': VIEW_CREATE,
  ...
  Employee: {
    Dashboard: VIEW_ONLY, Repairing: FULL, 'Repair Jobs': FULL, 'Online Bookings': FULL, 'CRM Leads': VIEW_ONLY,
    Billing: NONE, 'Invoice History': VIEW_ONLY, Stock: VIEW_ONLY, Employees: NONE,
